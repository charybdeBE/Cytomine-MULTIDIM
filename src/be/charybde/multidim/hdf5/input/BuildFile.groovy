...
public class BuildFile {
    ...
    public BuildFile(String filename, String original_filename, int x_start, int y_start, int width, int height, int burst){
        this.filename = filename
        this.memory = burst
    ...
    public void createParr(int coco, boolean divide = true){
        def cores = coco  - 1
